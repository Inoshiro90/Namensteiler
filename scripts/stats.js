...
function calcCVPatterns(names, gmap, vowelMin) {
  const groups = {};
  names.forEach(name => {
    const segs = parseWord(name, gmap, vowelMin, { silentFinalE: _silentFinalE, glideVowelPositional: _glideVowelPositional });
...
function calcLetterCombos(names, gmap, vowelMin) {
  ...
  names.forEach(rawName => {
    const segs = parseWord(rawName, gmap, vowelMin, { silentFinalE: _silentFinalE, glideVowelPositional: _glideVowelPositional });
    const n = segs.length;
...
function calcSyllableStats(names, gmap, vowelMin, cl) {
  ...
  const sylToCVPattern = (sylText) => {
    const segs = parseWord(sylText, gmap, vowelMin, { silentFinalE: _silentFinalE, glideVowelPositional: _glideVowelPositional });
